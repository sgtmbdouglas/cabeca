...
arrayOfValues.forEach((xablau, indexOfTheArray, theEntireArray) => {
  console.log('Cada elemento do array:', xablau);
...
const verifyGrades = (studentGrades) => {
  let sam = Object.values(studentGrades).some((grade) => grade === 'Aprovado');
   if(sam){
     console.log()
   }
};
